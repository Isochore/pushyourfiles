...
function showDownload() {
    ...
    $filepath = $_SERVER['DOCUMENT_ROOT'].'/pushyourfiles/cloud/'.$link_id.'.'.$extension;

    // Render twig de la page
    echo $twig->render('view_download.twig', array('base_url'=>$base_url ,'chemin'=> 'download/download/'.$link_id, 'name_file' => $nom, 'extension' => $extension));
}
